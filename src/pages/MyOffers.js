    ...
    <div>
      ...
      <div className="container mx-auto ">
        {/* <h1 class="text-3xl font-normal leading-normal mx-auto text-center lg:mx-72 mt-28 lg:text-left">
          ...
          <h1 className="align self-center text-center w-auto text-3xl mt-24">My Offers</h1>
        ...
        <div className="container py-4 mt-4">
          <ListItemOffer name={"John Fernando"} price={"120.00 Rs"} district={"Colombo"} scale={"Large"} rating={3}/>
          <ListItemOffer name={"Nimal Fernando"} price={"120.00 Rs"} district={"Colombo"} scale={"Large"} rating={4}/>
          <ListItemOffer name={"Kasun Fernando"} price={"120.00 Rs"} district={"Colombo"} scale={"Large"} rating={5}/>
          <ListItemOffer name={"Dinith Fernando"} price={"120.00 Rs"} district={"Colombo"} scale={"Large"} rating={2}/>
        </div>
      </div>
    </div>
  );
