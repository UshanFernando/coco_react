              ...
              <div class="flex flex-col col-span-4">
                <div class="flex flex-col gap-2 mt-4">
                  <div className="grid grid-cols-5 gap-2 ml-2">
                    ...
                    <div className={styles.detailValue}>2 months</div>

                    <div className={styles.detailName}> Total Land</div>
                    <div className={styles.detailValue}>24 Acres</div>

                    <div className={styles.detailName}> Yield Per Harvest</div>
                    <div className={styles.detailValue}>24,200</div>

                    <div className={styles.detailName}>
                      Total Number of Trees
                    </div>
                    <div className={styles.detailValue}>2500</div>

                    <div className={styles.detailName}>Inheritor Name</div>
                    <div className={styles.detailValue}>Kamal Jaysinghe</div>
                    ...
                    <div className={styles.detailValue}>Moratuwa</div>
